...
exports.defaultSignOptions = void 0;
exports.resolveManifest = resolveManifest;
exports.read = read;
exports.createSign = createSign;
exports.createIngredientFunction = createIngredientFunction;
...
function resolveManifest(manifestStore, manifest, resourceStore) {
...
function createSign(globalOptions) {
    return {
        /**
        ...
        async sign(props) {
            ...
            const signOptions = Object.assign({}, exports.defaultSignOptions, options);
            const signer = customSigner ?? globalOptions.signer;
            const memoryFileTypes = ['image/jpeg', 'image/png'];
            if (!signer) {
                throw new error_1.MissingSignerError();
            }
            if (!signOptions.embed && !signOptions.remoteManifestUrl) {
                throw new error_1.InvalidStorageOptionsError();
            }
            ...
            try {
                ...
                if (!manifest.definition.thumbnail) {
                    ...
                    thumbnail ||
                        ...
                        (globalOptions.thumbnail && thumbnail !== false
                            ? await (0, thumbnail_1.createThumbnail)(thumbnailInput, globalOptions.thumbnail)
                            : null);
                    if (thumbnailAsset) {
                ...
                throw new error_1.SigningError({ cause: err });
            }
        },
        /**
...
function createIngredientFunction(options) {
    /**
     * @notExported
