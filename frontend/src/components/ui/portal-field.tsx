...
const THEMES = {
  dark: { core: "#FFFFFF", fringe: "#00ffc6", isLight: 0 },
  light: { core: "#020202", fringe: "#00b894", isLight: 1 },
};
...
function buildSource(
  ...
  return PORTAL_FIELD_SOURCE.replace(
    ...
    .replace("__CORE_COLOR__", coreColor || theme.core)
    .replace("__FRINGE_COLOR__", fringeColor || theme.fringe)
...
export default function PortalFieldCollection({
  ...
  const source = useMemo(
    () => buildSource(mode, safeSize, safeLength, coreColor, fringeColor),
    [mode, safeSize, safeLength, coreColor, fringeColor],
  );
